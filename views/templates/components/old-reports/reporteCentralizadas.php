              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <?php
                      $pre1 = mysqli_query($con, "SELECT * FROM tbl_instituciones WHERE clasificacionAd='1' AND anio=$anio");
        ...
        <div class="col-lg-12" id="3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              ?>
              <h4 style="text-align: left;"> 1. Personal en instituciones de la Administración Central <span class="ml-5">TOTAL: <?php echo $sum1; ?></span></h4><br>
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <?php
                      $pre5 = mysqli_query($con, "SELECT SUM(isssteh) as isssteh, SUM(isstem) as isstem, SUM(issefhh) as issefhh, SUM(issefhm) as issefhm, SUM(imssh) as imssh, SUM(imssm) as imssm, SUM(otroh) as otroh, SUM(otrom) as otrom, SUM(sinseguroh) as sinseguroh, SUM(sinsegurom) as sinsegurom FROM `tbl_pregunta5` INNER JOIN tbl_instituciones ON tbl_pregunta5.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta5.anio=$anio");
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqqq = mysqli_query($con, "SELECT * FROM tbl_instituciones WHERE clasificacionAd='1' AND anio=$anio order by id asc");
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqfondosf = mysqli_query($con, "SELECT nueveuno.id_institu,nueveuno.institucion,nueveuno.option1 FROM `tbl_pregunta9-1` nueveuno inner join tbl_instituciones ins on nueveuno.id_institu=ins.id where ins.clasificacionAd='1' AND ins.anio=$anio AND nueveuno.anio=$anio order by nueveuno.id_institu asc");
                ...
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    $pre92 = mysqli_query($con, "SELECT
                                            ...
                                            WHERE b.clasificacionAd='1' AND a.anio=$anio AND b.anio=$anio");
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqfondosfsa = mysqli_query($con, "SELECT nuevetres.id_institu,nuevetres.institucion,nuevetres.option1 FROM `tbl_preguntas9-3` nuevetres inner join tbl_instituciones ins on nuevetres.id_institu=ins.id where ins.clasificacionAd='1' AND ins.anio=$anio AND nuevetres.anio=$anio order by nuevetres.id_institu asc");
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    <?php
                    $pre94 = mysqli_query($con, "SELECT SUM(fondo) as fondo FROM `tbl_pregunta9-4` INNER JOIN tbl_instituciones ON `tbl_pregunta9-4`.id_institu=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND `tbl_pregunta9-4`.anio=$anio");
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $pre10 = mysqli_query($con, "SELECT * FROM `tbl_pregunta10` INNER JOIN tbl_instituciones ON tbl_pregunta10.id_institu=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta10.anio=$anio order by id_institu asc");
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $pre11 = mysqli_query($con, "SELECT * FROM `tbl_pregunta11` INNER JOIN tbl_instituciones ON tbl_pregunta11.id_institu=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta11.anio=$anio order by id_institu asc");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqlC = mysqli_query($con, "SELECT * FROM  tbl_pregunta15 INNER JOIN tbl_instituciones ON tbl_pregunta15.idInst=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta15.anio=$anio order by idInst asc");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqeducativas = mysqli_query($con, "SELECT * FROM `tbl_pregunta16-3` diestres inner join tbl_instituciones ins on diestres.idIsnt=ins.id where ins.clasificacionAd='1' AND ins.anio=$anio AND diestres.anio=$anio order by idIsnt asc");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqsalud = mysqli_query($con, "SELECT * FROM `tbl_pregunta16-5` diezcinco INNER JOIN tbl_instituciones ins on diezcinco.idIsnt=ins.id where ins.clasificacionAd='1' AND ins.anio=$anio AND diezcinco.anio=$anio order by idIsnt asc");
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    <?php
                    $pre16_6 = mysqli_query($con, "SELECT SUM(totalClinicas) as totalClinicas, SUM(totalCentroSalud) as totalCentroSalud, SUM(totalHospitales) as totalHospitales, SUM(totalotrosalud) as totalotrosalud, SUM(total) as total,SUM(totalotrafunclinica) as totalotrafunclinica, SUM(totalotrafuncsa) as totalotrafuncsa, SUM(totalotrafunchos) as totalotrafunchos, SUM(totalotrafuncotro) as totalotrafuncotro, SUM(totalotra) as totalotra,SUM(Totalgral) as Totalgral FROM `tbl_pregunta16-6` INNER JOIN tbl_instituciones ON `tbl_pregunta16-6`.idInst=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND `tbl_pregunta16-6`.anio=$anio");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqfisicadepor = mysqli_query($con, "SELECT * FROM `tbl_pregunta16-7` diezsiete inner join tbl_instituciones ins on diezsiete.idInst=ins.id where ins.clasificacionAd='1' AND ins.anio=$anio AND diezsiete.anio=$anio order by idInst asc");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td>Instituciones de la Administración Central </td>
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqlCeee = mysqli_query($con, "SELECT * FROM `tbl_pregunta17` INNER JOIN tbl_instituciones ON tbl_pregunta17.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta17.anio=$anio order by idIns asc");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqlCeeee = mysqli_query($con, "SELECT * FROM `tbl_pregunta19` INNER JOIN tbl_instituciones ON tbl_pregunta19.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta19.anio=$anio order by idIns asc");
              ...
              <div class="table-responsive" style="text-align: center;">
                <table class="table table-sm table-bordered" id="refresh">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqlCCCe = mysqli_query($con, "SELECT * FROM `tbl_pregunta21` INNER JOIN tbl_instituciones ON tbl_pregunta21.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' AND tbl_instituciones.anio=$anio AND tbl_pregunta21.anio=$anio order by idIns asc");
              ...
              <div class="table-responsive">
                <table class="table table-sm table-bordered">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sqensenaza = mysqli_query($con, "SELECT * FROM `tbl_pregunta22-1` veintedos inner join tbl_instituciones ins on veintedos.idInst=ins.id where ins.clasificacionAd='1' AND ins.anio=$anio AND veintedos.anio=$anio order by idInst asc");
