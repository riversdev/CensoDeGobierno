            ...
            <div class="col-12">
                ...
                <div class="col-lg-12" id="1">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">Instituciones Paraestatales de la Administración Pública de la Entidad Federativa.</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <?php
                                            $pre1 = mysqli_query($con, "SELECT * FROM tbl_instituciones WHERE clasificacionAd='2' AND anio=$anio");
                ...
                <div class="col-lg-12" id="3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php
                            $pre3 = mysqli_query($con, "SELECT SUM(totalh2) as H FROM `tbl_instituciones` WHERE clasificacionAd='2' AND anio=$anio");
                            while ($rs3 = mysqli_fetch_array($pre3)) {
                                $totalh1 = $rs3['H'];
                            }
                            ?>
                            <?php
                            $p = mysqli_query($con, "SELECT SUM(totalm2) as M FROM `tbl_instituciones` WHERE clasificacionAd='2' AND anio=$anio");
                            while ($rs33 = mysqli_fetch_array($p)) {
                                $totalm1 = $rs33['M'];
                            }
                            $sum1 = $totalh1 + $totalm1;
                            ?>
                            <h4 style="text-align: left;"> 1. Personal en instituciones de la Administración Paraestatal <span class="ml-5">TOTAL: <?php echo $sum1; ?></span></h4><br>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                              ...
                              <td ><b>Institución de seguridad social</b></td>-->
                                        ...
                                        <tr>
                                            <?php
                                            $pre5 = mysqli_query($con, "SELECT SUM(isssteh) as isssteh, SUM(isstem) as isstem, SUM(issefhh) as issefhh, SUM(issefhm) as issefhm, SUM(imssh) as imssh, SUM(imssm) as imssm, SUM(otroh) as otroh, SUM(otrom) as otrom, SUM(sinseguroh) as sinseguroh, SUM(sinsegurom) as sinsegurom FROM `tbl_pregunta5` INNER JOIN tbl_instituciones ON tbl_pregunta5.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta5.anio=$anio");
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqqq = mysqli_query($con, "SELECT * FROM tbl_instituciones WHERE clasificacionAd='2' AND anio=$anio order by id asc");
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqfondosf = mysqli_query($con, "SELECT nueveuno.id_institu,nueveuno.institucion,nueveuno.option1 FROM `tbl_pregunta9-1` nueveuno inner join tbl_instituciones ins on nueveuno.id_institu=ins.id where ins.clasificacionAd='2' AND ins.anio=$anio AND nueveuno.anio=$anio order by nueveuno.id_institu asc");
                                ...
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        $pre92 = mysqli_query($con, "SELECT
                                                                ...
                                                                WHERE b.clasificacionAd='2' AND a.anio=$anio AND b.anio=$anio");
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqfondosfsa = mysqli_query($con, "SELECT nuevetres.id_institu,nuevetres.institucion,nuevetres.option1 FROM `tbl_preguntas9-3` nuevetres inner join tbl_instituciones ins on nuevetres.id_institu=ins.id where ins.clasificacionAd='2' AND ins.anio=$anio AND nuevetres.anio=$anio order by nuevetres.id_institu asc");
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        <?php
                                        $pre94 = mysqli_query($con, "SELECT SUM(fondo) as fondo FROM `tbl_pregunta9-4` INNER JOIN tbl_instituciones ON `tbl_pregunta9-4`.id_institu=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND `tbl_pregunta9-4`.anio=$anio");
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $pre10 = mysqli_query($con, "SELECT * FROM `tbl_pregunta10` INNER JOIN tbl_instituciones ON tbl_pregunta10.id_institu=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta10.anio=$anio order by id_institu asc");
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $pre11 = mysqli_query($con, "SELECT * FROM `tbl_pregunta11` INNER JOIN tbl_instituciones ON tbl_pregunta11.id_institu=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta11.anio=$anio order by id_institu asc");
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $se15 = mysqli_query($con, "SELECT SUM(tbl_pregunta15.admcpropio) as admcpropioo, SUM(tbl_pregunta15.admcrenta) as admcrenta, SUM(tbl_pregunta15.admncotro) as admncotro FROM `tbl_pregunta15` INNER JOIN tbl_instituciones ON tbl_instituciones.id=tbl_pregunta15.idInst WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta15.anio=$anio");
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-weight-bold"><?php echo $ssum1 = $admcpropio + $admcrenta + $admncotro; ?></td>
                                            <td><?php echo $admcpropio; ?></td>
                                            <td><?php echo $admcrenta; ?></td>
                                            <td><?php echo $admncotro; ?></td>
                                        </tr>
                                        <tr>
                                            <td class="font-weight-bold" align="right">TOTAL</td>
                                            <td style="font-size: 16px;"><b><?php echo $ssum1; ?></b></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcpropio; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcrenta; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admncotro; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqlC = mysqli_query($con, "SELECT * FROM  tbl_pregunta15 INNER JOIN tbl_instituciones ON tbl_pregunta15.idInst=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta15.anio=$anio order by idInst asc");
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqeducativas = mysqli_query($con, "SELECT * FROM `tbl_pregunta16-3` diestres inner join tbl_instituciones ins on diestres.idIsnt=ins.id where ins.clasificacionAd='2' AND ins.anio=$anio AND diestres.anio=$anio order by idIsnt asc");
                                                  ...
                                                  <div class="table-responsive" style="text-align: center;"> 
                                                    <table class="table table-sm table-bordered" id="refresh">
                                                      ...
                                                      <tr>
                                                        ...
                                                        <?php
                                                        /*$pre16_4=mysqli_query($con, "SELECT SUM(totalBienesInm) as totalBienesInm FROM `tbl_pregunta16-4` INNER JOIN tbl_instituciones ON `tbl_pregunta16-4`.idInst=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='1' ");
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqsalud = mysqli_query($con, "SELECT * FROM `tbl_pregunta16-5` diezcinco INNER JOIN tbl_instituciones ins on diezcinco.idIsnt=ins.id where ins.clasificacionAd='2' AND ins.anio=$anio AND diezcinco.anio=$anio order by idIsnt asc");
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        <?php
                                        $pre16_6 = mysqli_query($con, "SELECT SUM(totalClinicas) as totalClinicas, SUM(totalCentroSalud) as totalCentroSalud, SUM(totalHospitales) as totalHospitales, SUM(totalotrosalud) as totalotrosalud, SUM(total) as total,SUM(totalotrafunclinica) as totalotrafunclinica, SUM(totalotrafuncsa) as totalotrafuncsa, SUM(totalotrafunchos) as totalotrafunchos, SUM(totalotrafuncotro) as totalotrafuncotro, SUM(totalotra) as totalotra,SUM(Totalgral) as Totalgral FROM `tbl_pregunta16-6` INNER JOIN tbl_instituciones ON `tbl_pregunta16-6`.idInst=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND `tbl_pregunta16-6`.anio=$anio");
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqfisicadepor = mysqli_query($con, "SELECT * FROM `tbl_pregunta16-7` diezsiete inner join tbl_instituciones ins on diezsiete.idInst=ins.id where ins.clasificacionAd='2' AND ins.anio=$anio AND diezsiete.anio=$anio order by idInst asc");
                        ...
                        <div class="card-body">
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td rowspan="3" align="center"><b>Clasificación administrativa</b></td>
                                        ...
                                        ?>
                                        <tr>
                                            <td>Instituciones de la Administración Paraestatal </td>
                                            <td class="font-weight-bold" align="center"><label><?php echo $total; ?></label></td>
                                            <td align="center"><label><?php echo $admcauto; ?></label></td>
                                            <td align="center"><label><?php echo $admccamioneta; ?></label></td>
                                            <td align="center"><label><?php echo $admcmoto; ?></label></td>
                                            <td align="center"><label><?php echo $admcotro; ?></label></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right">TOTAL</th>
                                            <td class="text-center font-weight-bold"><?php echo array_sum($bu1); ?></td>
                                            <td class="text-center font-weight-bold"><?php echo array_sum($uto); ?></td>
                                            <td class="text-center font-weight-bold"><?php echo array_sum($neta); ?></td>
                                            <td class="text-center font-weight-bold"><?php echo array_sum($moto); ?></td>
                                            <td class="text-center font-weight-bold"><?php echo array_sum($cotro); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqlCeee = mysqli_query($con, "SELECT * FROM `tbl_pregunta17` INNER JOIN tbl_instituciones ON tbl_pregunta17.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta17.anio=$anio order by idIns asc");
                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="2" align="center"><b>Total</b></td>
                                            <td colspan="3" align="center"><b>Tipo</b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Fíjas</b></td>
                                            <td><b>Móviles</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center "><label><?php echo $admcfijos1; ?></label></td>
                                            <td class="text-center "><label><?php echo $admcmoviles1; ?></label></td>
                                            <td class="text-center font-weight-bold"><label><?php echo $va3 = $admcfijos2 + $admcmoviles2; ?></label></td>
                                            <td class="text-center "><label><?php echo $admcfijos2; ?></label></td>
                                            <td class="text-center "><label><?php echo $admcmoviles2; ?></label></td>
                                        </tr>
                                        <tr>
                                            <th class="text-right font-weight-bold">TOTAL</th>
                                            <td class="text-center font-weight-bold"><?php echo $va1; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcfijos1; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcmoviles1; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $va3; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcfijos2; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcmoviles2; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqlCeeee = mysqli_query($con, "SELECT * FROM `tbl_pregunta19` INNER JOIN tbl_instituciones ON tbl_pregunta19.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta19.anio=$anio order by idIns asc");
                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="2" align="center"><b>Multifuncionales</b></td>
                                            <td rowspan="2" align="center"><b>Servidores</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><b>Portátiles</b></td>
                                            <td align="center"><b>Para uso personal</b></td>
                                            <td align="center"><b>Para uso compartido</b></td>
                                            <td align="center"><b>Total</b></td>
                                            <td align="center"><b>Total</b></td>
                                            <td align="center"><b>Total</b></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Instituciones de la Administración Pública Paraestatal </td>
                                            <td align="center" class="font-weight-bold"><label><?php echo $s; ?></label></td>
                                            <td align="center"><label><?php echo $admccompues; ?></label></td>
                                            <td align="center"><label><?php echo $admccomppo; ?></label></td>
                                            <td align="center" class="font-weight-bold"><label><?php echo $s222; ?></label></td>
                                            <td align="center"><label><?php echo $admcimpper; ?></label></td>
                                            <td align="center"><label><?php echo $admcimpcom; ?></label></td>
                                            <td align="center" class="font-weight-bold"><label><?php echo $totalcmultf; ?></label></td>
                                            <td align="center" class="font-weight-bold"><label><?php echo $totalcserv; ?></label></td>
                                            <td align="center" class="font-weight-bold"><label><?php echo $totalctablet; ?></label></td>
                                        </tr>
                                        <?php
                                        ...
                                        <tr>
                                            <th class="text-right font-weight-bold">TOTAL</th>
                                            <td class="text-center font-weight-bold"><?php echo $s; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admccompues; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admccomppo; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $s222; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcimpper; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $admcimpcom; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $totalcmultf; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $totalcserv; ?></td>
                                            <td class="text-center font-weight-bold"><?php echo $totalctablet; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive" style="text-align: center;">
                                <table class="table table-sm table-bordered" id="refresh">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqlCCCe = mysqli_query($con, "SELECT * FROM `tbl_pregunta21` INNER JOIN tbl_instituciones ON tbl_pregunta21.idIns=tbl_instituciones.id WHERE tbl_instituciones.clasificacionAd='2' AND tbl_instituciones.anio=$anio AND tbl_pregunta21.anio=$anio order by idIns asc");
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sqensenaza = mysqli_query($con, "SELECT * FROM `tbl_pregunta22-1` veintedos inner join tbl_instituciones ins on veintedos.idInst=ins.id where ins.clasificacionAd='2' AND ins.anio=$anio AND veintedos.anio=$anio order by idInst asc");
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $pre22_2 = mysqli_query(
                                            $con,
                                            "SELECT SUM(CompuEdBasica) as CompuEdBasica, SUM(CompuEdMediaS) as CompuEdMediaS,  SUM(CompuEdSup) as CompuEdSup, SUM(CompuEdotro) as CompuEdotro, SUM(totalComFEduc) as totalComFEduc,
